...
INPUT_ISO="ubuntu-21.10-desktop-amd64.iso"
OUTPUT_ISO="ubuntu-ja-21.10-desktop-amd64-$(date '+%Y%m%d').iso"
VOLUME_ID="Ubuntu 21.10 ja amd64"
NAMESERVER="1.1.1.1"
RELEASE_NOTES_URL="https://wiki.ubuntu.com/ImpishIndri/ReleaseNotes/Ja"
UBUNTU_VERSION="21.10"
CODE_NAME="Impish Indri"
CODE_NAME_SHORT="impish"
TIMEZONE="Asia/Tokyo"
ZONEINFO_FILE="/usr/share/zoneinfo/Asia/Tokyo"
#ARCHIVE_MIRROR="http://ftp.naist.jp/pub/Linux/ubuntu/"
ARCHIVE_MIRROR="http://jp.archive.ubuntu.com/ubuntu/"
...
apt-get update
apt-get install -y ubuntu-defaults-ja ubuntu-ja-live-fix gnome-user-docs-ja libreoffice-help-ja libreoffice-l10n-ja thunderbird-locale-ja
apt-get upgrade -y thunderbird thunderbird-gnome-support thunderbird-locale-en thunderbird-locale-en-us thunderbird-locale-ja ubiquity ubiquity-frontend-gtk ubiquity-ubuntu-artwork ibus-mozc mozc-data mozc-server mozc-utils-gui
