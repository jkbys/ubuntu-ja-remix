...
INPUT_ISO="ubuntu-21.04-desktop-amd64.iso"
OUTPUT_ISO="ubuntu-ja-21.04-desktop-amd64-$(date '+%Y%m%d').iso"
VOLUME_ID="Ubuntu 21.04 ja amd64"
NAMESERVER="1.1.1.1"
RELEASE_NOTES_URL="https://wiki.ubuntu.com/HirsuteHippo/ReleaseNotes/Ja"
UBUNTU_VERSION="21.04"
CODE_NAME="Hirsute Hippo"
CODE_NAME_SHORT="hirsute"
TIMEZONE="Asia/Tokyo"
